...
urlpatterns = [
    ...
    path('colaboradores',views.colaboradores,name='listagem_funcionario'),
    
    
    path('visualizar_colaboradores',views.visualizar_colaboradores, name='visualizar_colaboradores'),
